    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('disponivel', 'Disponível'), ('emprestado', 'Emprestado'), ('reservado', 'Reservado'), ('indisponivel', 'Indisponível')], default='disponivel', max_length=20)),
            ],
            options={
                'db_table': 'exemplar',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('colecao', models.CharField(blank=True, max_length=150, null=True)),
                ('quantidade', models.IntegerField(default=1)),
                ('codigo_base', models.CharField(blank=True, max_length=50, null=True)),
                ('prateleira', models.CharField(blank=True, max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('turma', models.CharField(blank=True, max_length=5, null=True)),
                ('serie', models.CharField(blank=True, max_length=50, null=True)),
                ('primeiro_acesso', models.BooleanField(default=True)),
                ('tipo_usuario', models.CharField(choices=[('aluno', 'Aluno'), ('exaluno', 'Ex-aluno'), ('bibliotecario', 'Bibliotecário')], default='aluno', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('observacoes', models.TextField(blank=True)),
                ('exemplar', models.ForeignKey(db_column='id_exemplar', on_delete=django.db.models.deletion.CASCADE, to='biblioteca.exemplar')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pendente', 'Pendente'), ('cancelada', 'Cancelada'), ('concluida', 'Concluída')], default='pendente', max_length=20)),
